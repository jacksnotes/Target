...
import { initializeNotifications, setupNotificationResponseListener } from "@/lib/notification-manager";
...
function RootLayoutContent() {
  ...
  // Initialize notifications and setup response listener
  useEffect(() => {
    const setupNotifications = async () => {
      await initializeNotifications();
      setupNotificationResponseListener((goalId) => {
